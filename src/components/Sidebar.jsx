  ...
  useEffect(() => {
    const handleMouseMove = (e) => {
      if (catRef.current) {
        ...
        const leftEyeCenterX = catRect.left + 85 + 6;
        const leftEyeCenterY = catRect.top + 50 + 6;
        const rightEyeCenterX = catRect.left + 105 + 6;
        const rightEyeCenterY = catRect.top + 50 + 6;
    ...
    <>
      ...
      `}>
        ...
        <div className="flex gap-4 pb-2 items-center justify-center">
          {/* ✅ Updated mail icon */}
          <a 
            href="mailto:kuntalankitaa@email.com"
            className="w-8 h-8 flex items-center justify-center cursor-pointer transition-transform duration-200 hover:scale-110 group"
          >
            <FaEnvelope className="w-8 h-8 text-black group-hover:text-green-500" />
          </a>

          <a href="https://github.com/Ankita-kuntal" target="_blank" rel="noopener noreferrer" className="w-8 h-8 flex items-center justify-center cursor-pointer transition-transform duration-200 hover:scale-110 group">
            <FaGithub className="w-8 h-8 text-black group-hover:text-[#3e014b]" />
          </a>
          <a href="https://www.linkedin.com/in/ankita-kuntal/" target="_blank" rel="noopener noreferrer" className="w-8 h-8 flex items-center justify-center cursor-pointer transition-transform duration-200 hover:scale-110 group">
            <FaLinkedin className="w-8 h-8 text-black group-hover:text-blue-600" />
          </a>
          <a href="https://www.instagram.com/ankyyyyyyy_/" target="_blank" rel="noopener noreferrer" className="w-8 h-8 flex items-center justify-center cursor-pointer transition-transform duration-200 hover:scale-110 group">
